...
import { Task, TaskBoard, User } from "../../App";

export default function Tags({ board, user }: { board: TaskBoard; user: User }) {
  ...
  return (
    <div className="board">
      <div className="board-header">
        <h3>{board.title}</h3>
        <button onClick={() => setEditTasks(!editTasks)} className="add-task">{editTasks ? 'Cancel' : 'Edit'}</button>
      </div>
      {editTasks && (
